...
export default function HomeScreen() {
  ...
  }, [currentIndex, position, triggerHaptic, jobs, refetchJobs, addSwipedJobId, supabaseUserId, userProfile]);
  ...
  return (
    <TabTransitionWrapper routeName="home">
      ...
      {currentIndex < jobs.length && (
        <View style={[styles.actionBar, { paddingBottom: Math.max(insets.bottom, 10) + 8 }]}>
...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 12, fontWeight: '800' as const, color: Colors.textTertiary, letterSpacing: 2, textTransform: 'uppercase' as const },
  ...
  headerTitle: { fontSize: 22, fontWeight: '800' as const, color: Colors.secondary },
  headerSubtitle: { fontSize: 14, color: Colors.textTertiary, marginTop: 2 },
  headerActions: { flexDirection: 'row', gap: 10 },
  headerButton: { width: 42, height: 42, borderRadius: 14, backgroundColor: Colors.surface, justifyContent: 'center', alignItems: 'center', shadowColor: Colors.cardShadow, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 1, shadowRadius: 8, elevation: 2, position: 'relative' as const },
  filterBadge: { position: 'absolute' as const, top: -4, right: -4, width: 18, height: 18, borderRadius: 9, backgroundColor: Colors.accent, justifyContent: 'center', alignItems: 'center' },
  filterBadgeText: { fontSize: 10, fontWeight: '700' as const, color: Colors.surface },
  aiButton: { width: 42, height: 42, borderRadius: 14, backgroundColor: Colors.accentSoft, justifyContent: 'center', alignItems: 'center' },
  feedToggleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 20, paddingVertical: 6 },
  feedToggleBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: Colors.background, borderWidth: 1, borderColor: Colors.borderLight },
  feedToggleBtnActive: { backgroundColor: '#111111', borderColor: '#111111' },
  feedToggleText: { fontSize: 13, fontWeight: '600' as const, color: Colors.textSecondary },
  feedToggleTextActive: { color: '#FFFFFF' },
  feedToggleBadge: { backgroundColor: Colors.borderLight, paddingHorizontal: 6, paddingVertical: 1, borderRadius: 8 },
  feedToggleBadgeActive: { backgroundColor: 'rgba(255,255,255,0.2)' },
  feedToggleBadgeText: { fontSize: 10, fontWeight: '700' as const, color: Colors.textTertiary },
  feedToggleBadgeTextActive: { color: '#FFFFFF' },
  activeSearchContainer: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: Colors.background },
  activeSearchScroll: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  activeSearchTag: { backgroundColor: Colors.primary, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  activeSearchTagText: { fontSize: 13, fontWeight: '600' as const, color: Colors.surface },
  clearSearchButton: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: Colors.errorSoft, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  clearSearchText: { fontSize: 12, fontWeight: '600' as const, color: Colors.error },
  ...
  likeLabel: { top: 40, left: 24, backgroundColor: Colors.accentSoft, borderWidth: 2, borderColor: Colors.accent },
  likeLabelText: { fontSize: 24, fontWeight: '900' as const, color: Colors.accent, letterSpacing: 2 },
  nopeLabel: { top: 40, right: 24, backgroundColor: Colors.errorSoft, borderWidth: 2, borderColor: Colors.error },
  nopeLabelText: { fontSize: 24, fontWeight: '900' as const, color: Colors.error, letterSpacing: 2 },
  saveLabel: { bottom: 60, alignSelf: 'center', left: '35%', backgroundColor: '#EEEEEE', borderWidth: 2, borderColor: Colors.textPrimary },
  saveLabelText: { fontSize: 24, fontWeight: '900' as const, color: Colors.textPrimary, letterSpacing: 2 },
  actionBar: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 20, paddingTop: 12, paddingHorizontal: 20, backgroundColor: Colors.background },
  actionButton: { justifyContent: 'center', alignItems: 'center', borderRadius: 999, shadowColor: Colors.cardShadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 1, shadowRadius: 12, elevation: 4 },
  passButton: { width: 60, height: 60, backgroundColor: Colors.surface, borderWidth: 2, borderColor: Colors.errorSoft },
  saveActionButton: { width: 50, height: 50, backgroundColor: Colors.surface, borderWidth: 2, borderColor: '#EEEEEE' },
  applyButton: { width: 60, height: 60, backgroundColor: '#E8F5E9', borderWidth: 2, borderColor: '#00C853' },
  activePass: { backgroundColor: Colors.error, borderColor: Colors.error },
  activeSave: { backgroundColor: Colors.textPrimary, borderColor: Colors.textPrimary },
  activeApply: { backgroundColor: Colors.accent, borderColor: Colors.accent },
  emptyState: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40 },
  emptyIcon: { width: 80, height: 80, borderRadius: 24, backgroundColor: Colors.primarySoft, justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  emptyTitle: { fontSize: 22, fontWeight: '800' as const, color: Colors.secondary, marginBottom: 8 },
  emptyText: { fontSize: 15, color: Colors.textSecondary, textAlign: 'center', lineHeight: 22 },
  resetButton: { marginTop: 24, paddingHorizontal: 28, paddingVertical: 14, backgroundColor: Colors.secondary, borderRadius: 14 },
  resetButtonText: { fontSize: 16, fontWeight: '700' as const, color: Colors.textInverse },
  filterOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  filterContent: { backgroundColor: Colors.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '90%' },
  ...
  filterTitle: { fontSize: 22, fontWeight: '800' as const, color: Colors.secondary },
  filterCloseBtn: { width: 36, height: 36, borderRadius: 12, backgroundColor: Colors.background, justifyContent: 'center', alignItems: 'center' },
  filterDivider: { height: 1, backgroundColor: Colors.borderLight, marginVertical: 14 },
  filterScroll: { paddingHorizontal: 20 },
  filterSectionTitle: { fontSize: 15, fontWeight: '700' as const, color: Colors.secondary, marginTop: 18, marginBottom: 10 },
  salaryHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  filterCurrencyBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, backgroundColor: Colors.background, borderWidth: 1, borderColor: Colors.borderLight },
  filterCurrencyText: { fontSize: 13, fontWeight: '600' as const, color: Colors.textPrimary },
  cityPickerBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.background, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 14, borderWidth: 1, borderColor: Colors.borderLight, gap: 10 },
  cityPickerBtnText: { flex: 1, fontSize: 15, color: Colors.textSecondary },
  selectedCitiesWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 10 },
  selectedCityChip: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: Colors.secondary, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  selectedCityText: { fontSize: 12, color: Colors.surface, fontWeight: '600' as const },
  salarySliderWrap: { backgroundColor: Colors.background, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: Colors.borderLight },
  ...
  keywordSearchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.background, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, gap: 10, borderWidth: 1.5, borderColor: Colors.primary },
  keywordSearchInput: { flex: 1, fontSize: 15, color: Colors.textPrimary, padding: 0, fontWeight: '500' as const },
  ...
  filterChipText: { fontSize: 14, color: Colors.textPrimary, fontWeight: '600' as const },
  ...
  resetFilterBtn: { flex: 1, paddingVertical: 14, borderRadius: 14, borderWidth: 1, borderColor: Colors.border, alignItems: 'center' },
  resetFilterBtnText: { fontSize: 16, fontWeight: '700' as const, color: Colors.textPrimary },
  applyFilterBtn: { flex: 2, paddingVertical: 14, borderRadius: 14, backgroundColor: Colors.secondary, alignItems: 'center' },
  applyFilterBtnText: { fontSize: 16, fontWeight: '700' as const, color: Colors.textInverse },
  cityList: { paddingHorizontal: 20, maxHeight: 400 },
  cityOption: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 14, borderRadius: 12, marginBottom: 6, backgroundColor: Colors.background, borderWidth: 1, borderColor: Colors.borderLight },
  cityOptionActive: { backgroundColor: Colors.secondary, borderColor: Colors.secondary },
  cityOptionText: { fontSize: 14, fontWeight: '600' as const, color: Colors.textPrimary },
  cityOptionTextActive: { color: Colors.surface },
  cityDoneBtn: { marginHorizontal: 20, marginVertical: 16, paddingVertical: 14, borderRadius: 14, backgroundColor: Colors.secondary, alignItems: 'center' },
  cityDoneBtnText: { fontSize: 16, fontWeight: '700' as const, color: Colors.textInverse },
  ...
  searchTag: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: Colors.primary, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  searchTagText: { fontSize: 12, color: Colors.surface, fontWeight: '600' as const },
  notificationContainer: { position: 'absolute' as const, left: 16, right: 16, zIndex: 1000 },
  notificationCard: { backgroundColor: Colors.surface, borderRadius: 16, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 16, elevation: 12, borderWidth: 1, borderColor: Colors.borderLight },
  notificationLogo: { width: 52, height: 52, borderRadius: 12, backgroundColor: Colors.borderLight },
  notificationContent: { flex: 1 },
  notificationTitle: { fontSize: 11, fontWeight: '600' as const, color: Colors.textTertiary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: 4 },
  notificationCompany: { fontSize: 17, fontWeight: '700' as const, color: Colors.secondary, marginBottom: 2 },
  notificationRole: { fontSize: 14, color: Colors.textSecondary, lineHeight: 18 },
});

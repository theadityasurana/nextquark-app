...
const faqs = [
  ...
  { q: 'Is NextQuark free to use?', a: 'Yes! The basic version is free with 40 applications per month. You can create a profile, swipe on jobs, apply, and message recruiters. We also offer Pro (200 apps/month) and Premium (500 apps/month) plans with additional features like AI-assisted applications, priority visibility, and resume management.' },
  ...
  { q: 'What is the Premium plan?', a: 'Premium offers 500 applications/month, AI-assisted applications, enhanced profile placement, resume management, salary insights, unlimited messages, priority support, exclusive job listings, interview preparation tools, and a profile analytics dashboard.' },

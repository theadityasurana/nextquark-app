...
const faqs = [
  ...
  { q: 'Is NextQuark free to use?', a: 'Yes! The basic version is free with 15 daily swipes. You can create a profile, swipe on jobs, apply, and message recruiters. We also offer a Premium plan with unlimited applications, 3 resume uploads, AI-assisted applications, priority visibility, and more.' },
  ...
  { q: 'Can I apply to multiple jobs at the same time?', a: 'Absolutely! Free users get 15 daily swipes, and Premium users get unlimited applications. We recommend being selective and applying to roles that genuinely interest you. Quality applications with tailored messages tend to get better responses.' },

    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {job.detailedRequirements ? (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Detailed Requirements</Text>
            <Text style={styles.descriptionText}>{job.detailedRequirements}</Text>
          </View>
        ) : null}
      ...
      <View style={[styles.bottomBar, { paddingBottom: Math.max(insets.bottom, 16) }]}>
        ...
        <Pressable style={styles.applyBtn} onPress={handleApplyNow} disabled={isApplying}>

...
export default function SignInScreen() {
  const { signInWithEmail, signInWithApple, signInWithGoogle, isAuthenticated, isOnboardingComplete, isSwitchingAccount } = useAuth();
  ...
  // Navigate after a fresh sign-in completes on this screen
  useEffect(() => {
...
const styles = StyleSheet.create({
  ...
  inputGroup: { backgroundColor: '#1C1C1E', borderRadius: 12, overflow: 'hidden', marginBottom: 16 },

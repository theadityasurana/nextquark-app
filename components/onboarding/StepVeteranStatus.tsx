...
export default function StepVeteranStatus({ data, onUpdate, onNext }: StepProps) {
  ...
  const canContinue = !!data.veteranStatus;
    ...
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>This information is collected for compliance purposes. It will not affect your job matches.</Text>
          <Text style={styles.sectionTitle}>Are you a protected veteran?</Text>
          <View style={styles.options}>
            {VETERAN_OPTIONS.map((opt, idx) => {
